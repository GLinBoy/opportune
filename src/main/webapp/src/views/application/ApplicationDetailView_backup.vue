    ...
    <div v-if="!loading && application">
      ...
      <div class="d-flex justify-space-between align-center mb-6">
        <div>
          ...
          <!-- Company name (will be a link to company page in the future) -->
      ...
      <!-- 1. Application Details (Combined Information) -->
      <v-card class="mb-6">
        ...
        <v-card-text>
          <v-form ref="applicationForm" v-model="formValid">
            <v-row>
              <v-col cols="12" md="6">
                <v-text-field
              ...
              <v-col cols="12" md="6">
                <v-text-field
                  v-model="application.salaryRange"
                  label="Salary Range"
                  variant="outlined"
      ...
      <v-card class="mb-6">
        ...
        <v-tabs v-model="activeTab" color="primary" align-tabs="start">
          <v-tab value="job-description">
            <v-icon icon="mdi-file-document" class="mr-2" />
            Job Description
          </v-tab>
          <v-tab value="cover-letter">
            <v-icon icon="mdi-email" class="mr-2" />
            Cover Letter
          </v-tab>
          <v-tab value="resume-enhancer">
            <v-icon icon="mdi-account-edit" class="mr-2" />
            Resume Enhancer
          </v-tab>
          <v-tab value="interview-details">
            <v-icon icon="mdi-account-voice" class="mr-2" />
            Interview Details
          </v-tab>
        </v-tabs>
        ...
        <v-tabs-window v-model="activeTab">
          <v-tabs-window-item value="job-description">
            <v-card-text>
              <div class="d-flex justify-space-between align-center mb-4">
                <h3 class="text-h6">AI Analyzed Job Description</h3>
                <v-btn
                  color="primary"
                  variant="outlined"
                  prepend-icon="mdi-refresh"
                  size="small"
                  @click="regenerateJobDescription"
                >
                  Regenerate
                </v-btn>
              </div>
              <v-textarea
                ...
                label="AI Generated Job Description Analysis"
                variant="outlined"
                rows="8"
                readonly
          ...
          <v-tabs-window-item value="cover-letter">
            <v-card-text>
              <div class="d-flex justify-space-between align-center mb-4">
                <h3 class="text-h6">AI Generated Cover Letter</h3>
                <v-btn
                  color="primary"
                  variant="outlined"
                  prepend-icon="mdi-refresh"
          ...
          <v-tabs-window-item value="resume-enhancer">
            <v-card-text>
              <div class="d-flex justify-space-between align-center mb-4">
                <h3 class="text-h6">Resume Enhancement Suggestions</h3>
                <v-btn
                  color="primary"
                  variant="outlined"
                  prepend-icon="mdi-refresh"
                  size="small"
                  @click="regenerateResumeEnhancer"
                >
                  Regenerate
                </v-btn>
              </div>
              <v-textarea
                ...
                label="AI Resume Enhancement Suggestions"
                variant="outlined"
                rows="10"
                readonly
                placeholder="AI resume enhancement suggestions will appear here..."
              />
            </v-card-text>
          </v-tabs-window-item>
          ...
          <v-tabs-window-item value="interview-details">
            <v-card-text>
              <div class="d-flex justify-space-between align-center mb-4">
                <h3 class="text-h6">Interview Preparation Details</h3>
                <v-btn
                  color="primary"
                  variant="outlined"
                  prepend-icon="mdi-refresh"
                  size="small"
                  @click="regenerateInterviewDetails"
                >
                  Regenerate
                </v-btn>
              </div>
              <v-textarea
                ...
                label="AI Generated Interview Preparation"
                variant="outlined"
                rows="10"
                readonly
                placeholder="AI interview preparation content will appear here..."
              />
            </v-card-text>
          </v-tabs-window-item>
        </v-tabs-window>
