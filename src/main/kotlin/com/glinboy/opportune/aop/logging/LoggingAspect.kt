package com.glinboy.opportune.aop.logging
...
class LoggingAspect(private val env: Environment) {
	 ...
	 */
	@Pointcut(
		"within(com.glinboy.opportune.repository..*)" +
			" || within(com.glinboy.opportune.service..*)" +
			" || within(com.glinboy.opportune.web.rest..*)"
	)
